/*************************************************************************
	...
	> Created Time: 日 10/ 7 14:14:54 2018
 ************************************************************************/
...
int RUN_ALL_TEST() {
    struct FuncData ret;
    ret.next = NULL;
    for (struct FuncData *p = FuncData_head, *q; p; p = p->next) {
        q = p->next;
        p->next = ret.next;
        ret.next = p;
    }
    ...
    char color[3][100] = {
        "[  \033[1;32m%.2f%% \033[0m] totle : %d expect : %d\n",
        "[  \033[0;31m%.2f%% \033[0m] totle : %d expect : %d\n",
        "[  \033[1;31m%.2f%% \033[0m] totle : %d expect : %d\n",
    };
